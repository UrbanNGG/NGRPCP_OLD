...
<a href="" onclick="javascript:window.open('http://127.0.0.1/cp/loginhelp.php','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;">Need help logging in?</a> |
