...
?>
			...
			<table cellpadding='0' class='double_pad' cellspacing='0' border='0' width='100%'>
				<form action="index.php?p=editpass" method="POST">
						<tr class="tablerow1"><td>Current Password</td><td><input type="password" name="oPass" length="64"></td></tr>
						<tr><td>New Password</td><td><input type="password" name="nPass" length="64"></td></tr>
						<tr class="tablerow1"><td>Repeat New Password</td><td><input type="password" name="rnPass" length="64"></td></tr>
