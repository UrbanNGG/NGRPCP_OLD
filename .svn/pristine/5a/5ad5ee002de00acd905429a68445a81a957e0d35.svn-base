...
<div class='acp-box'>
	...
	<?php $gmod1 = mysql_query("SELECT `id`, `Username`, `UpdateDate`, `IP`, `AdminLevel`, `FMember`, `GangModerator` FROM `accounts` WHERE `AdminLevel`<'1338' AND `GangModerator`>'0' AND `Disabled`='0' ORDER BY GangModerator DESC, Username ASC");
