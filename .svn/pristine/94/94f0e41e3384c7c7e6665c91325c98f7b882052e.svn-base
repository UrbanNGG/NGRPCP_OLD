...
<div class='acp-box'>
		...
		<table cellpadding='0' class='double_pad' cellspacing='0' border='0' width='100%'>
			...
			<tr>
				...
				<td><select name="admin_id">
					<?php 
					$userquery = mysql_query("SELECT `id`,`Username`,`Disabled` FROM `accounts` WHERE `AdminLevel`>'1' AND `AdminLevel`<'1338' AND `ShopTech`='0' AND `Disabled`='0' ORDER BY Username ASC");
	...
	<?php $sql = mysql_query("SELECT `id`,`Username`,`UpdateDate`,`IP`,`ShopTech`,`ShopTechOrders` FROM `accounts` WHERE `ShopTech`>'0' AND `AdminLevel`<'1338' AND `Disabled`='0' ORDER BY ShopTech DESC, Username ASC");
