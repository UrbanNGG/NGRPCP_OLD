<?php
require_once('infos/tc_calendar.php');
...
<link href="global/css/calendar.css" rel="stylesheet" type="text/css" />
...
<div id="calendar-page">
    <div id="calendar-header" align="center">
        <?php if($dp){ ?>
        <div align="right" class="closeme"><a href="javascript:closeMe();"><img src="global/images/close.jpg" border="0" /></a></div>	
        <?php } ?>
