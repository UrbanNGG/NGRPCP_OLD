...
<div class='acp-box'>
	<h3>Modifying <?php echo $faction['name']; ?></h3>
		...
		<form method="post" action="gameaffairs/proc.php">
			...
			<tr class='tablerow1'>
				<td>Division 6</td>
				<td><input type="text" length="64" size="50" name="div6" value="<?php echo $faction['div_6']; ?>"></td>
			</tr>
			<tr>
				<td>Division 7</td>
				<td><input type="text" length="64" size="50" name="div7" value="<?php echo $faction['div_7']; ?>"></td>
			</tr>
