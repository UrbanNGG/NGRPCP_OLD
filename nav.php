<ul id='section_buttons'>
	...
	<?php if($inf["Business"] != -1) {
		if($_SERVER["SCRIPT_NAME"] == "/business.php") { ?><li class='active'><?php } else { ?><li><?php } ?><a href='business.php?p=info'><img src='http://<?php echo $_SERVER['SERVER_NAME']; ?>/global/images/all/applications/subscriptions.png' alt='' /> Business</a></li>
	<?php } ?>
